...
<head>
    ...
    <script>
			function validate() {
                ...
                var religion = document.forms["jsForm"]["religion"].value;
                var preaddress = document.forms["jsForm"]["preaddress"].value;
                var paraddress = document.forms["jsForm"]["paraddress"].value;
                var phone = document.forms["jsForm"]["phone"].value;
                var email = document.forms["jsForm"]["email"].value;
                var pweblink = document.forms["jsForm"]["pweblink"].value;
                var username = document.forms["jsForm"]["username"].value;
				var password = document.forms["jsForm"]["password"].value;
                
				if(fname == "" || lname == ""|| gender == ""|| dob == ""|| religion == ""|| preaddress == "" || paraddress == ""|| phone == ""|| email ==""|| pweblink == ""|| username==""|| password=="") {
